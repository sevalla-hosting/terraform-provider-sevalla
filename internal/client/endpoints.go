...
var UsedEndpoints = []Endpoint{
	...
	{Method: "DELETE", Path: "/v3/databases/{id}/internal-connections/{connection_id}"},
	...
	{Method: "DELETE", Path: "/v3/load-balancers/{id}/destinations/{destination_id}"},
	{Method: "POST", Path: "/v3/load-balancers/{id}/destinations/{destination_id}/toggle"},
	...
	{Method: "GET", Path: "/v3/object-storage/{id}/cors-policies"},
	{Method: "POST", Path: "/v3/object-storage/{id}/cors-policies"},
	{Method: "PATCH", Path: "/v3/object-storage/{id}/cors-policies/{cors_policy_id}"},
	{Method: "DELETE", Path: "/v3/object-storage/{id}/cors-policies/{cors_policy_id}"},

	// Domains — per service type (spec no longer documents a generic template).
	{Method: "GET", Path: "/v3/applications/{id}/domains"},
	{Method: "POST", Path: "/v3/applications/{id}/domains"},
	{Method: "GET", Path: "/v3/applications/{id}/domains/{domain_id}"},
	{Method: "DELETE", Path: "/v3/applications/{id}/domains/{domain_id}"},
	{Method: "POST", Path: "/v3/applications/{id}/domains/{domain_id}/set-primary"},
	{Method: "POST", Path: "/v3/applications/{id}/domains/{domain_id}/toggle"},
	{Method: "POST", Path: "/v3/applications/{id}/domains/{domain_id}/refresh-status"},

	{Method: "GET", Path: "/v3/static-sites/{id}/domains"},
	{Method: "POST", Path: "/v3/static-sites/{id}/domains"},
	{Method: "GET", Path: "/v3/static-sites/{id}/domains/{domain_id}"},
	{Method: "DELETE", Path: "/v3/static-sites/{id}/domains/{domain_id}"},
	{Method: "POST", Path: "/v3/static-sites/{id}/domains/{domain_id}/set-primary"},
	{Method: "POST", Path: "/v3/static-sites/{id}/domains/{domain_id}/toggle"},
	{Method: "POST", Path: "/v3/static-sites/{id}/domains/{domain_id}/refresh-status"},

	{Method: "GET", Path: "/v3/load-balancers/{id}/domains"},
	{Method: "POST", Path: "/v3/load-balancers/{id}/domains"},
	{Method: "GET", Path: "/v3/load-balancers/{id}/domains/{domain_id}"},
	{Method: "DELETE", Path: "/v3/load-balancers/{id}/domains/{domain_id}"},
	{Method: "POST", Path: "/v3/load-balancers/{id}/domains/{domain_id}/set-primary"},
	{Method: "POST", Path: "/v3/load-balancers/{id}/domains/{domain_id}/toggle"},
	{Method: "POST", Path: "/v3/load-balancers/{id}/domains/{domain_id}/refresh-status"},

	// Env vars — per service type.
	{Method: "GET", Path: "/v3/applications/{id}/env-vars"},
	{Method: "POST", Path: "/v3/applications/{id}/env-vars"},
	{Method: "PUT", Path: "/v3/applications/{id}/env-vars/{env_var_id}"},
	{Method: "DELETE", Path: "/v3/applications/{id}/env-vars/{env_var_id}"},

	{Method: "GET", Path: "/v3/static-sites/{id}/env-vars"},
	{Method: "POST", Path: "/v3/static-sites/{id}/env-vars"},
	{Method: "PUT", Path: "/v3/static-sites/{id}/env-vars/{env_var_id}"},
	{Method: "DELETE", Path: "/v3/static-sites/{id}/env-vars/{env_var_id}"},
